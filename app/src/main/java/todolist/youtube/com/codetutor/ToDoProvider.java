    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] strings, @Nullable String s, @Nullable String[] strings1, @Nullable String s1) {
        ...
        switch (MATCHER.match(uri)) {
            case TODOS_LIST:
                ...
                break;
            case TODOS_FROM_SPECIFIC_PLACE:
                cursor = toDoListDBAdapter.getCursorForSpecificPlace(strings1[0]);
                break;
            case TODOS_COUNT:
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues contentValues) throws UnsupportedOperationException {
        ...
        switch (MATCHER.match(uri)) {
            case TODOS_LIST:
                ...
                Log.d("abc", "call update todo list");
                break;
            default:
